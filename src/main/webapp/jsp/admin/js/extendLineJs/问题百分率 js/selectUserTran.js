...
function reDrawUserTran()
{
    ...
    startBut.onclick = function()
    {
        ...
        $.post(baseUrl+"conversion.do?start="+startTime+"&end="+endTime,$("#dataForm").serialize(),function(data)
        {
            ...
            for(var i = 0; timestamp2 <= timestamp3; i++)
            {
            	...
            	if(dataLen==0){
                    ...
                    }else
                    {
                        ...
                        UserTranRateArr[j] = (newUserNumArr[j] / IpNumArr[j]*100).toFixed(2);  // 用户转化率
                    }
