...
<div>
    <ul>
        <li><a href="">充值</a></li>
        <li><a href="depositAccount.jsp">提现</a></li>
    </ul>
</div>
<!--充值表单-->
<form action="">
    充值数额: <input type="text"/><p>BTC, 最小充值额度为0.001BTC, 折合为: ￥200.25</p>
    充值密码: <input type="password"/><a href="">设置充值密码</a>
